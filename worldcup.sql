...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 01. Mai 2021 um 09:21
...
(1, '2021-05-01', '2021-05-01 07:11:43', 1, 1);
...
--
ALTER TABLE `discipline`
  MODIFY `discipline_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `event`
  ADD CONSTRAINT `event_ibfk_1` FOREIGN KEY (`discipline_id`) REFERENCES `discipline` (`discipline_id`),
